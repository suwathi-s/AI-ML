...
# Load raw data
data = pd.read_csv(r"C:\Users\91902\OneDrive\Desktop\customer conversion analysis\test_data.csv")
...
print("Feature engineering complete. Output: test_features.csv")
